    ...
    <body>
        ...
        <div id="about">
            <div id='aboutme' class="panel">
                ...
                <p>Теперь о главном.  Я ищу работу Java разработчика. Беря во внимание, что у меня нет коммерческого опыта разработки на Java,
                    ...
                    Надеюсь, Вас заинтересует моя кандидатура. Связаться со мной можно по электронной почте <a href="mailto:resumeapp@mail.ru">
                        resumeapp@mail.ru</a>, другие контакты можно найти в моем резюме на <a href="http://hh.ru/resume/012636baff01d35c230039ed1f6f6652473737" target="_blank">hh.ru</a>. </p>
            </div>
            <div id='aboutproj' class="panel">
                ...
                <p>
                В роли веб-сервера и контейнера сервлетов выступает <em>Apache Tomcat</em>. В качестве базы данных выбрана <em>MySQL</em>.
                ...
                <em>Maven,Tomcat</em> (и много чего ещё), собирает и деплоит проекты без каких либо дополнительных усилий. В качестве <em>VCS</em> использовался
                <em>GIT</em>,
                ...
                весьма трудоемкий процесс и не входит в ближайшие планы. Функционал протестирован на FireFox 15.0.1, Opera 10.63, Google Chrome	34.0, на другом может не работать.</p> 

                <h2>Изобретая квадратные велосипеды...</h2>
                <img height="200"  src='resources/common_image/Bycicle.jpg'>
                <p>Название этого пункта - сочетание  двух антипаттернов «Изобретение велосипеда»
                ...
                <p>P.S. Спасибо <a href="http://www.shutterstock.com/gallery-2168897p1.html" target="_blank">автору</a> за предоставленные изображения</p>
                <div>
