    ...
    <body>
        ...
        <div id="about">
            ...
            <div id='aboutproj' class="panel">
                ...
                весьма трудоемкий процесс и не входит в ближайшие планы. Функционал протестирован на FireFox 15.0.1, Opera 10.63 <em>?Чём?</em>, на другом может не работать.</p> 
