    ...
    <body>
        ...
        <div id="about">
            ...
            <div id='aboutproj' class="panel">
                ...
                <h3>Используемые средства и технологии.</h3>
                <center><img id='springimg' height="120"  src='resources/common_image/Spring.jpg'></center>
                <p>
                ...
                работать с более низкоуровневыми вещами и стандартной библиотекой. На мой взгляд, осваивать технологии лучше с низкого уровня.
                При подобном подходе достигается лучшее понимание устройства и организации более высокоуровневых компонентов, что значительно упрощает
                их последующее освоение и использование.  Исключение составляет <em>JavaScript</em>, с которым я до начала этого проекта не работал.
                ...
                избыточным, пестрит антипаттернами и присутствует исключительно ради обеспечения функционала.  Помимо <em>Servlets & JSP</em> используется
                <em>JSTL</em>,
                ...
                <h3>Изобретая квадратные велосипеды.</h3>
