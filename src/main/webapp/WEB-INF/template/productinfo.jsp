...
<c:set var="OriginProdIco" value="<img class='prodStatIcon' title='Ключевой продукт. Этот продукт виден всем пользователям и являющийся прообразом для пользовательских продуктов.'height='16' width='16' src='resources/common_image/icons/Key.gif' alt='Ключевой'>"/>
...
<c:set var="UsersProdIco" value="<img class='prodStatIcon' title='Пользовательская копия продукта. Вы можете изменить некоторые свойства своей копии  ключевого продукта (задать цену, комментарий и т.д.).При этом, не тронутые свойства, будут соответствовать свойствам ключевого продукта.' height='16' width='16' src='resources/common_image/icons/Users.gif' alt='Пользовательский'>"/>
