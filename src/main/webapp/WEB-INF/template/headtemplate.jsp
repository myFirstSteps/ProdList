...
<div id="HeadTemplate">
    ...
    <div  id='logo' class="HeadTemplate" ><img src="<c:url value="/resources/common_image/OCP_JavaSE7Programmer.gif"/>"  width="140" height="71" alt="OCP_JavaSE7Programmer.gif"></div>
